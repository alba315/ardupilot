...
#define GCS_ADDR_HIGH 0xFF
#define GCS_ADDR_LOW  0xFE

//Stores the grounstation Xbee header and footer
static    uint8_t xbee_api_hdr[17] = {0};
...
/*AÑADIDO*/
	 ...
	 xbee_sum=xbee_sum+ck[0]+ck[1];
	     ...
	     xbee_api_hdr[0] = 0x7E;
	     xbee_api_hdr[1] = 0x00;
	     xbee_api_hdr[2] = (length+MAVLINK_NUM_HEADER_BYTES+0x02+0x0E); //0x02 es longitud del checksum //+longitud_cabecera - 3 (xq son longitud(2) delimitador(1))
	     xbee_api_hdr[3] = 0x10;
	     xbee_api_hdr[4] = 0x01;
		if (msgid!=227){
	     xbee_api_hdr[5] = 0x00;  // Inicio de MAC
	     xbee_api_hdr[6] = 0x00;
	     xbee_api_hdr[7] = 0x00;
	     xbee_api_hdr[8] = 0x00;
         xbee_api_hdr[9] = 0x00;
	     xbee_api_hdr[10] = 0x00;
	     xbee_api_hdr[11] = 0x00;
	     xbee_api_hdr[12] = 0x00;  // Final de la MAC
	 	}else{
	 	 xbee_api_hdr[5] = 0x00;  // Inicio de MAC
	     xbee_api_hdr[6] = 0x00;
	     xbee_api_hdr[7] = 0x00;
	     ...
	     xbee_api_hdr[9] = 0x00;
	     xbee_api_hdr[10] = 0x00;
	     xbee_api_hdr[11] = 0xFF;
	     xbee_api_hdr[12] = 0xFC;  // Final de la MAC
	 	}
	     xbee_api_hdr[13] = GCS_ADDR_HIGH;
	     xbee_api_hdr[14] = GCS_ADDR_LOW;
	     xbee_api_hdr[15] = 0x00;
	     xbee_api_hdr[16] = 0x00;

	//Broadcast, pro deberia ser la del cordinador
	     xbee_sum+=xbee_api_hdr[3]+xbee_api_hdr[4]+xbee_api_hdr[5]+xbee_api_hdr[6]+xbee_api_hdr[7]+xbee_api_hdr[8]+xbee_api_hdr[9]+xbee_api_hdr[10]+xbee_api_hdr[11]+xbee_api_hdr[12]+xbee_api_hdr[13]+xbee_api_hdr[14]+xbee_api_hdr[15]+xbee_api_hdr[16];
	     xbee_chksum[0]=(0xFF-xbee_sum) & 0x000000FF;
					      
	_mavlink_send_uart(chan,(const char *)xbee_api_hdr,17); //17 de los parametros del header
	//
...
MAVLINK_HELPER void _mavlink_resend_uart(mavlink_channel_t chan, const mavlink_message_t *msg)
{
	...
	/*AÑADIDO*/
	_mavlink_send_uart(chan,(const char *)xbee_api_hdr,17);
	//
