...
# include USERHOOK_VARIABLES
    ...
    struct {
        ...
        /****AÑADIDO****/
        uint32_t last_positioning_data;  // the time when the last POSITIONING_DATA message arrived from a GCS - used for triggering gcs failsafe
        /****AÑADIDO****/
 ...
 #error Unrecognised frame type
    ...
    /***AÑADIDO***/
    void gcs_send_positioning_data(void);
    /***AÑADIDO***/
    ...
    /***AÑADIDO***/
    void send_positioning_data(mavlink_channel_t chan);
    /***AÑADIDO***/
