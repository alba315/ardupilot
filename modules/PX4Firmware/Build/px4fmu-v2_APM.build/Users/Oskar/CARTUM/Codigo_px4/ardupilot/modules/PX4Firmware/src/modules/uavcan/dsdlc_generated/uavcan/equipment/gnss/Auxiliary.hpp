 ...
 *
 * Source file: /Users/Oskar/CARTUM/Codigo_px4/ardupilot/modules/uavcan/dsdl/uavcan/equipment/gnss/302.Auxiliary.uavcan
 */
...
saturated bool differential_corrections_applied
******************************************************************************/
...
#undef sats_visible
#undef sats_used
#undef differential_corrections_applied
...
struct UAVCAN_EXPORT Auxiliary_
{
    ...
    struct FieldTypes
    {
        ...
        typedef ::uavcan::IntegerSpec< 1, ::uavcan::SignednessUnsigned, ::uavcan::CastModeSaturate > differential_corrections_applied;
    };
    ...
    enum
    {
        MinBitLen
            ...
            + FieldTypes::differential_corrections_applied::MinBitLen
    };
    ...
    enum
    {
        MaxBitLen
            ...
            + FieldTypes::differential_corrections_applied::MaxBitLen
    };
    ...
    typename ::uavcan::StorageType< typename FieldTypes::differential_corrections_applied >::Type differential_corrections_applied;
    ...
    Auxiliary_()
        ...
        , sats_visible()
        , sats_used()
        , differential_corrections_applied()
    {
         ...
         */
        ::uavcan::StaticAssert<126 == MaxBitLen>::check();
#endif
    }
...
bool Auxiliary_<_tmpl>::operator==(ParameterType rhs) const
{
    return
        ...
        differential_corrections_applied == rhs.differential_corrections_applied;
}
...
bool Auxiliary_<_tmpl>::isClose(ParameterType rhs) const
{
    return
        ...
        ::uavcan::areClose(differential_corrections_applied, rhs.differential_corrections_applied);
}
    ...
    ::uavcan::TailArrayOptimizationMode tao_mode)
{
    ...
    res = FieldTypes::differential_corrections_applied::encode(self.differential_corrections_applied, codec,  tao_mode);
    return res;
}
    ...
    ::uavcan::TailArrayOptimizationMode tao_mode)
{
    ...
    res = FieldTypes::differential_corrections_applied::decode(self.differential_corrections_applied, codec,  tao_mode);
    return res;
}
...
{
    ::uavcan::DataTypeSignature signature(0xFD083B119E4CE25BULL);
    ...
    FieldTypes::differential_corrections_applied::extendDataTypeSignature(signature);
...
void YamlStreamer< ::uavcan::equipment::gnss::Auxiliary >::stream(Stream& s, ::uavcan::equipment::gnss::Auxiliary::ParameterType obj, const int level)
{
    ...
    s << "differential_corrections_applied: ";
    YamlStreamer< ::uavcan::equipment::gnss::Auxiliary::FieldTypes::differential_corrections_applied >::stream(s, obj.differential_corrections_applied, level + 1);
}
