 ...
 *
 * Source file: /Users/Oskar/CARTUM/Codigo_px4/ardupilot/modules/uavcan/dsdl/uavcan/equipment/camera_gimbal/Mode.uavcan
 */
...
saturated uint4 command_mode
saturated uint4 COMMAND_MODE_ANGULAR_VELOCITY = 0
saturated uint4 COMMAND_MODE_GEO_POI = 3
saturated uint4 COMMAND_MODE_ORIENTATION_BODY_FRAME = 2
saturated uint4 COMMAND_MODE_ORIENTATION_FIXED_FRAME = 1
******************************************************************************/
...
struct UAVCAN_EXPORT Mode_
{
    ...
    {
        typedef ::uavcan::IntegerSpec< 4, ::uavcan::SignednessUnsigned, ::uavcan::CastModeSaturate > COMMAND_MODE_ANGULAR_VELOCITY;
        typedef ::uavcan::IntegerSpec< 4, ::uavcan::SignednessUnsigned, ::uavcan::CastModeSaturate > COMMAND_MODE_ORIENTATION_FIXED_FRAME;
        typedef ::uavcan::IntegerSpec< 4, ::uavcan::SignednessUnsigned, ::uavcan::CastModeSaturate > COMMAND_MODE_ORIENTATION_BODY_FRAME;
        typedef ::uavcan::IntegerSpec< 4, ::uavcan::SignednessUnsigned, ::uavcan::CastModeSaturate > COMMAND_MODE_GEO_POI;
    };

    struct FieldTypes
    {
        typedef ::uavcan::IntegerSpec< 4, ::uavcan::SignednessUnsigned, ::uavcan::CastModeSaturate > command_mode;
    };
        ...
        : command_mode()
    {
         ...
         */
        ::uavcan::StaticAssert<4 == MaxBitLen>::check();
#endif
    }
...
{
    ::uavcan::DataTypeSignature signature(0x2DA984816184B15ULL);
