 ...
 *
 * Source file: /Users/Oskar/CARTUM/Codigo_px4/ardupilot/modules/uavcan/dsdl/uavcan/protocol/551.GetNodeInfo.uavcan
 */
...
struct UAVCAN_EXPORT GetNodeInfo_
{
    ...
    struct Response_
    {
        ...
        struct FieldTypes
        {
            ...
            typedef ::uavcan::Array< ::uavcan::IntegerSpec< 8, ::uavcan::SignednessUnsigned, ::uavcan::CastModeSaturate >, ::uavcan::ArrayModeDynamic, 63 > name;
        };
...
{
    ::uavcan::DataTypeSignature signature(0x308E2C1CA1DC6B54ULL);
