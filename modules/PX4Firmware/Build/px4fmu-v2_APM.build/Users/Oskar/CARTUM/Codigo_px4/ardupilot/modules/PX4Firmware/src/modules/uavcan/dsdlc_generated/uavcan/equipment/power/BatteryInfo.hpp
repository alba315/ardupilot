 ...
 *
 * Source file: /Users/Oskar/CARTUM/Codigo_px4/ardupilot/modules/uavcan/dsdl/uavcan/equipment/power/712.BatteryInfo.uavcan
 */
...
struct UAVCAN_EXPORT BatteryInfo_
{
    ...
    struct FieldTypes
    {
        ...
        typedef ::uavcan::IntegerSpec< 6, ::uavcan::SignednessUnsigned, ::uavcan::CastModeSaturate > battery_index;
    ...
    enum
    {
        MinBitLen
            ...
            + FieldTypes::battery_index::MinBitLen
    ...
    enum
    {
        MaxBitLen
            ...
            + FieldTypes::battery_index::MaxBitLen
    ...
    typename ::uavcan::StorageType< typename FieldTypes::battery_index >::Type battery_index;
...
bool BatteryInfo_<_tmpl>::operator==(ParameterType rhs) const
{
    return
        ...
        battery_index == rhs.battery_index &&
...
bool BatteryInfo_<_tmpl>::isClose(ParameterType rhs) const
{
    return
        ...
        ::uavcan::areClose(battery_index, rhs.battery_index) &&
    ...
    ::uavcan::TailArrayOptimizationMode tao_mode)
{
    ...
    res = FieldTypes::battery_index::encode(self.battery_index, codec,  ::uavcan::TailArrayOptDisabled);
    if (res <= 0)
    {
        return res;
    }
    ...
    ::uavcan::TailArrayOptimizationMode tao_mode)
{
    ...
    res = FieldTypes::battery_index::decode(self.battery_index, codec,  ::uavcan::TailArrayOptDisabled);
    if (res <= 0)
    {
        return res;
    }
...
{
    ::uavcan::DataTypeSignature signature(0x6E65A6478F84C5E3ULL);
    ...
    FieldTypes::battery_index::extendDataTypeSignature(signature);
...
void YamlStreamer< ::uavcan::equipment::power::BatteryInfo >::stream(Stream& s, ::uavcan::equipment::power::BatteryInfo::ParameterType obj, const int level)
{
    ...
    s << "battery_index: ";
    YamlStreamer< ::uavcan::equipment::power::BatteryInfo::FieldTypes::battery_index >::stream(s, obj.battery_index, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
